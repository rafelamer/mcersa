...
const char *gengetopt_args_info_usage = "Usage: mcersa [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->noaes_help = gengetopt_args_info_help[10] ;
  args_info->encryptkey_help = gengetopt_args_info_help[11] ;
  args_info->decryptkey_help = gengetopt_args_info_help[12] ;
  args_info->sign_help = gengetopt_args_info_help[13] ;
  args_info->verify_help = gengetopt_args_info_help[14] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:edgb:ak:ncrsv", long_options, &option_index);
